...
<<<<<<< HEAD
<<<<<<< HEAD
	@echo "  make test-integration - Runs backend integration tests with Docker PostgreSQL (port 5433)."
=======
	@echo "  make test-integration - Runs backend integration tests against a live database."
>>>>>>> f7356dc (fix: frontent pipeline)
=======
	@echo "  make test-integration - Runs backend integration tests with Docker PostgreSQL (port 5433)."
>>>>>>> 7adfa99 (fix: frontent pipeline)
